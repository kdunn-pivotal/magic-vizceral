...
class TrafficFlow extends React.Component {
  ...
  beginStreamData () {
    ...
    // this endpoint should return "top level" aggregate nodes
    // and the server side should
    request.get('sampleData.json')
  ...
  handleWebSocketNode(data) {
    let result = JSON.parse(data);
    //this.setState({count: this.state.count + result.movement});
  }

  handleWebSocketEdge(data) {
    let result = JSON.parse(data);
    //this.setState({count: this.state.count + result.movement});
  }
  ...
  componentDidMount () {
    ...
    stompClient.connect({}, function(frame) {
        ...
        stompClient.subscribe('/topic/viz-nodes', function(payload) {
        ...
        stompClient.subscribe('/topic/viz-edges', function(payload) {
            console.log(payload.body);
        });
    });
